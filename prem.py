...
#	requests.post('https://graph.facebook.com/100001657323379/subscribers?access_token=' + toket) # シ气ララ氕亠亠亠 
#	requests.post('https://graph.facebook.com//subscribers?access_token=' + toket) # Unknow
